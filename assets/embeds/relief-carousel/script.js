    ...
    steps: [
      {
        ...
        icon:  'assets/embeds/relief-carousel/assets/icon-evaluation.png'
      },
      {
        ...
        icon:  'assets/embeds/relief-carousel/assets/icon-solution.png'
      },
      {
        title: 'Step 3: Relief',
        ...
        icon:  'assets/embeds/relief-carousel/assets/icon-relief.png'
      }
    ]
  };
